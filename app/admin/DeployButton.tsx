...
export default function DeployButton() {
  ...
  return (
    <button
      ...
      className="p-4 bg-indigo-600 text-white rounded-2xl border border-indigo-500 text-xs font-bold hover:bg-indigo-700 transition duration-200 flex items-center justify-center gap-2"
    >
