...
export default function Docs() {
  const sections = [
    { title: 'User Manual', icon: Book, href: '/docs/user-manual', desc: 'Everything you need to know to get started.' },
    { title: 'Landing Copy', icon: Code, href: '/docs/landing-copy', desc: 'Marketing and positioning strategy.' },
    { title: 'Changelog', icon: History, href: '/docs/changelog', desc: 'Recent updates and architectural decisions.' },
    { title: 'Roadmap', icon: Map, href: '/docs/roadmap', desc: 'The future of SheetSync.' },
  ];
