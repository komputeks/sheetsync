...
import { LogIn, Mail, Lock, ShieldCheck, User } from 'lucide-react';
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-slate-900 dark:bg-indigo-600 text-white py-4 rounded-2xl font-bold hover:bg-slate-800 dark:hover:bg-indigo-700 transition active:scale-95 disabled:opacity-50"
              >
